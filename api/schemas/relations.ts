...
import { admin_users, admin_permissions, admin_roles, strapi_api_tokens, strapi_api_token_permissions, strapi_transfer_tokens, strapi_transfer_token_permissions, files, upload_folders, strapi_releases, strapi_release_actions, i18n_locale, up_permissions, up_roles, up_users, answers, events, event_galleries, execs, introductions, partners, peoples, previous_teams, questions, socials, some_photos, tickets, user_tickets, values, admin_permissions_role_links, admin_users_roles_links, strapi_api_token_permissions_token_links, strapi_transfer_token_permissions_token_links, files_related_morphs, files_folder_links, upload_folders_parent_links, strapi_release_actions_release_links, up_permissions_role_links, up_users_role_links, answers_people_id_links, answers_question_id_links, questions_ticket_id_links, tickets_event_id_links, user_tickets_people_id_links, user_tickets_ticket_id_links } from "./schema";
...
export const admin_usersRelations = relations(admin_users, ({one, many}) => ({
	...
	strapi_api_token_permissions_created_by_id: many(strapi_api_token_permissions, {
		relationName: "strapi_api_token_permissions_created_by_id_admin_users_id"
	}),
	strapi_api_token_permissions_updated_by_id: many(strapi_api_token_permissions, {
	...
	strapi_transfer_token_permissions_created_by_id: many(strapi_transfer_token_permissions, {
		relationName: "strapi_transfer_token_permissions_created_by_id_admin_users_id"
	}),
	strapi_transfer_token_permissions_updated_by_id: many(strapi_transfer_token_permissions, {
		relationName: "strapi_transfer_token_permissions_updated_by_id_admin_users_id"
	}),
...
export const admin_permissionsRelations = relations(admin_permissions, ({one, many}) => ({
	admin_user_created_by_id: one(admin_users, {
...
export const strapi_api_tokensRelations = relations(strapi_api_tokens, ({one, many}) => ({
	admin_user_created_by_id: one(admin_users, {
	...
	strapi_api_token_permissions_token_links: many(strapi_api_token_permissions_token_links),
}));

export const strapi_api_token_permissionsRelations = relations(strapi_api_token_permissions, ({one, many}) => ({
	admin_user_created_by_id: one(admin_users, {
...
export const strapi_transfer_tokensRelations = relations(strapi_transfer_tokens, ({one, many}) => ({
	admin_user_created_by_id: one(admin_users, {
	...
	strapi_transfer_token_permissions_token_links: many(strapi_transfer_token_permissions_token_links),
}));

export const strapi_transfer_token_permissionsRelations = relations(strapi_transfer_token_permissions, ({one, many}) => ({
	admin_user_created_by_id: one(admin_users, {
...
export const upload_foldersRelations = relations(upload_folders, ({one, many}) => ({
	admin_user_created_by_id: one(admin_users, {
	...
	upload_folders_parent_links_inv_folder_id: many(upload_folders_parent_links, {
		relationName: "upload_folders_parent_links_inv_folder_id_upload_folders_id"
	}),
}));

export const strapi_releasesRelations = relations(strapi_releases, ({one, many}) => ({
	admin_user_created_by_id: one(admin_users, {
	...
	strapi_release_actions_release_links: many(strapi_release_actions_release_links),
}));

export const strapi_release_actionsRelations = relations(strapi_release_actions, ({one, many}) => ({
	admin_user_created_by_id: one(admin_users, {
...
export const up_permissionsRelations = relations(up_permissions, ({one, many}) => ({
	admin_user_created_by_id: one(admin_users, {
...
export const event_galleriesRelations = relations(event_galleries, ({one}) => ({
	admin_user_created_by_id: one(admin_users, {
...
export const user_ticketsRelations = relations(user_tickets, ({one, many}) => ({
	admin_user_created_by_id: one(admin_users, {
...
export const admin_permissions_role_linksRelations = relations(admin_permissions_role_links, ({one}) => ({
...
export const admin_users_roles_linksRelations = relations(admin_users_roles_links, ({one}) => ({
...
export const strapi_api_token_permissions_token_linksRelations = relations(strapi_api_token_permissions_token_links, ({one}) => ({
	strapi_api_token_permission: one(strapi_api_token_permissions, {
		fields: [strapi_api_token_permissions_token_links.api_token_permission_id],
...
export const strapi_transfer_token_permissions_token_linksRelations = relations(strapi_transfer_token_permissions_token_links, ({one}) => ({
	strapi_transfer_token_permission: one(strapi_transfer_token_permissions, {
		fields: [strapi_transfer_token_permissions_token_links.transfer_token_permission_id],
...
export const files_related_morphsRelations = relations(files_related_morphs, ({one}) => ({
	file: one(files, {
...
export const files_folder_linksRelations = relations(files_folder_links, ({one}) => ({
	file: one(files, {
...
export const upload_folders_parent_linksRelations = relations(upload_folders_parent_links, ({one}) => ({
...
export const strapi_release_actions_release_linksRelations = relations(strapi_release_actions_release_links, ({one}) => ({
...
export const up_permissions_role_linksRelations = relations(up_permissions_role_links, ({one}) => ({
...
export const up_users_role_linksRelations = relations(up_users_role_links, ({one}) => ({
...
export const answers_people_id_linksRelations = relations(answers_people_id_links, ({one}) => ({
	answer: one(answers, {
...
export const answers_question_id_linksRelations = relations(answers_question_id_links, ({one}) => ({
	answer: one(answers, {
...
export const questions_ticket_id_linksRelations = relations(questions_ticket_id_links, ({one}) => ({
	question: one(questions, {
...
export const tickets_event_id_linksRelations = relations(tickets_event_id_links, ({one}) => ({
	ticket: one(tickets, {
...
export const user_tickets_people_id_linksRelations = relations(user_tickets_people_id_links, ({one}) => ({
...
export const user_tickets_ticket_id_linksRelations = relations(user_tickets_ticket_id_links, ({one}) => ({
	user_ticket: one(user_tickets, {
