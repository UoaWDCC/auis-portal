...
describe('FormInput Component', () => {
  ...
  it('shows error message', () => {
    render(<FormInput placeholder="e.g Clark" name="firstName" errorMessage="First Name is Required" />);
    expect(screen.getByText(/First Name is Required/i)).toBeInTheDocument();
  });

  it('handles input change', () => {
    const handleChange = vi.fn();
    render(<FormInput placeholder="e.g Clark" name="firstName" onChange={handleChange} />);
