        ...
        <div className="from-AUIS-dark-teal to-AUIS-teal min-h-svh bg-gradient-to-b pb-20">
          ...
          <div>
            <h1 className="pt-12 text-center text-lg text-white">
              ...
              {customerEmail}. */}
              Payment successful. Thank you for purchasing a ticket. Please provide your AUIS Account email address at the door. That will be your ticket. You will NOT recive a confirmation email. Feel free to screenshot this as proof of purchase.
            </h1>
