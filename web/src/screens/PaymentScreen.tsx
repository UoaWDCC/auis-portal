...
function PaymentScreen() {
  return (
    ...
    <div className="mt-[8rem] items-center pl-[4rem] pr-[5rem] md:pl-[10rem] md:pr-[10rem]">
        <h1
          data-testid="title"
          className="pb-[1rem] pl-[1rem] text-4xl md:text-5xl font-bold"
        >
          Review Order
        </h1>
        <div className="w-3/4 border-b border-gray-300"> </div>
        <div>
          <h2 data-testid="subTitle" className="pt-[2rem] text-l md:text-xl font-bold">
            {" "}
            Two Semester Membership:
          </h2>
          <h3 className="text-sm md:text-lg pt-[0.5rem]"> 
      ...
      <div className="h-screen items-center pl-[1rem] pr-[5rem] md:pl-[10rem] md:pr-[10rem]">
        <div>
          <div className="flex flex-row items-center justify-center space-x-5 pt-[2rem] sm:justify-end lg:pr-[20rem]">
            ...
            <h2 data-testid="price" className="txt-l md:text-xl font-[500] justify-center">
              {" "}
              $15.00 NZD{" "}
            </h2>
            <button
              data-testid="button"
              className="h-8 md:h-10 rounded-xl bg-orange-400 px-4 text-l md:text-xl font-bold text-white"
            >
              {" "}
              Continue{" "}
            </button>
