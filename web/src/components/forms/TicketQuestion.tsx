...
export default function TicketQuestion({question, indexId, onAnswerChange} : {question : string, indexId : number, onAnswerChange : (e: React.ChangeEvent<HTMLInputElement>, indexId : number) => void;}) {
