...
export default function PlatinumPartnerCard({
  ...
  return (
    <>
      <div className="relative flex h-full w-80 flex-col items-center">
        {/* Platinum Badge */}
        ...
        <button
          className="m-3 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 px-6 py-3 font-bold text-white shadow-lg transition-all hover:scale-110 hover:shadow-xl"
          onClick={handleClick}
        >
          View Sponsor
        </button>
